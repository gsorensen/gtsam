...
//------------------------------------------------------------------------------
template class GTSAM_EXPORT PreintegrationBase<imuBias::ConstantBias>;
template GTSAM_EXPORT std::ostream& operator<<(
    std::ostream& os, const PreintegrationBase<imuBias::ConstantBias>& pim);
