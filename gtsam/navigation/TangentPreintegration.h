...
class GTSAM_EXPORT TangentPreintegration : public PreintegrationBase<Bias> {
 protected:
  ...
  Matrix93 preintegrated_H_biasAcc_;    ///< Jacobian of preintegrated_ w.r.t.
                                        ///< acceleration bias
  Matrix93 preintegrated_H_biasOmega_;  ///< Jacobian of preintegrated_ w.r.t.
                                        ///< angular rate bias

  /// Default constructor for serialization
  TangentPreintegration() { resetIntegration(); }
 ...
 public:
  ...
  // Update integrated vector on tangent manifold preintegrated with
  // acceleration Static, functional version.
  ...
  // Compose the two pre-integrated 9D-vectors zeta01 and zeta02, with
  // derivatives
  static Vector9 Compose(const Vector9& zeta01, const Vector9& zeta12,
                         double deltaT12, OptionalJacobian<9, 9> H1 = {},
                         OptionalJacobian<9, 9> H2 = {});

  /// Merge in a different set of measurements and update bias derivatives
  /// accordingly The derivatives apply to the preintegrated Vector9
