...
class PreintegrationBaseT;

template <typename Bias>
std::ostream& operator<<(std::ostream& os, const PreintegrationBaseT<Bias>& pim);

/**
 * PreintegrationBaseT is the base class for PreintegratedMeasurements
...
class GTSAM_EXPORT PreintegrationBaseT {
 public:
  typedef PreintegrationParams Params;

  PreintegrationBaseT(const std::shared_ptr<Params>& p, const Bias& biasHat)
 ...
 public:
  ...
  /// Params object.
  bool matchesParamsWith(const PreintegrationBaseT& other) const {
  ...
  GTSAM_EXPORT friend std::ostream& operator<< <Bias>(std::ostream& os,
                                               const PreintegrationBaseT<Bias>& pim);
