...
class GTSAM_EXPORT ManifoldPreintegration : public PreintegrationBase<Bias> {
 protected:
  ...
  ManifoldPreintegration() { resetIntegration(); }
 ...
 public:
  ...
  ManifoldPreintegration(const std::shared_ptr<Params>& p, const Bias& biasHat)
